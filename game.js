...
var config = {
    ...
    player: new Player(),
    upgrades: {
        advertising : new Upgrade("advertising", 1000, 1000, false),
        repairs : new Upgrade("repairs", 3000, 5000, false),
        customerService : new Upgrade("improved customer service", 2500, 1500, false),
        backyardPool : new Upgrade("install swimming pool", 4000, 2000, false),
        extraInventory : new Upgrade("extended inventory", 10000, 4000, false),
        gasPumps : new Upgrade("gaspumps outside", 15000, 5500, false),
    },
    assets: {
